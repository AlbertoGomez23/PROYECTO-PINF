...
\begin{itemize}
\item Aprovechar la gran capacidad de un procesador simb\'{o}lico como \texttt{Mathematica}, para el c\'{a}lculo de los par\'{a}metros y curvas de un eclipse de Sol.
...
\item Comprensi\'{o}n del desarrollo del eclipse en zonas cr\'{\i}ticas.
...
\end{itemize}
\item De la direcci\'{o}n del eje de la sombra en el sistema fundamental se obtienen los elementos $d$ y $\mu$.
\item Las coordenadas $\xi$ y $\eta$ de la Luna en el sistema fundamental proporcionan los elementos $x$ e $y$.
\item Por trigonometr\'{\i}a se calculan los elementos $i_{p}, i_{s}, l_{p}$ y $l_{s}$.
\end{itemize}
...
\begin{center}
$\zeta=0, \qquad \dfrac{\eta^2}{b^2}+\xi^2=1, \qquad \dfrac{d(\zeta)}{dt}=0.$
\end{center}
...
Se calcula, mediante \verb"FindRoot", el instante en que los puntos de la curva de m\'{a}ximo en el horizonte tienen una distancia al borde del cono.}

\only<2>{
En estas figuras se muestran los mapas sin haber calculado espec\'{\i}ficamente los puntos anteriores.
\begin{center}
  ...
  \newline
  \bigskip
  {\small Datos cada cinco minutos \qquad \qquad Datos cada minuto \qquad \qquad}
\end{center}}
...
\begin{itemize}
    ...
    \item Obtenci\'{o}n de puntos caracter\'{\i}sticos de forma m\'{a}s eficaz que iteraciones.
    \item Gran herramienta para el dibujo.
    \item Hallazgo de nueva curva l\'{\i}mite en zonas cr\'{\i}ticas de algunos eclipses.
    \item Utilidad de programas para la secci\'{o}n de Efem\'{e}rides del ROA.
\end{itemize}
