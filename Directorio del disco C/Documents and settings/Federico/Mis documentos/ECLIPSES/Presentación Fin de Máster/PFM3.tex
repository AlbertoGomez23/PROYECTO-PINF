...
\begin{itemize}
  \item Si min($q-l_{p}>0$): no hay eclipse.
  \item Si min($q-l_{p}\leq0$) y min($q-l_{s}>0$): Eclipse parcial. 
  \item Si min($q-l_{s}\leq0$) y min($q>0$): Eclipse no central.
  \item Si min($q\leq0$) y min($q+l_{s}>0$): Eclipse central con una sola curva de totalidad.
  \item Si min($q+l_{s}\leq0$) y min($q+l_{p}>0$): Eclipse central con una sola curva de parcialidad.
  \item Si min($q+l_{p}\leq0$): Eclipse central con las dos curvas de parcialidad.
\end{itemize}
...
\begin{itemize}
    ...
    \item Obtenci\'{o}n de puntos caracter\'{\i}sticos de forma m\'{a}s eficaz que mediante iteraciones.
