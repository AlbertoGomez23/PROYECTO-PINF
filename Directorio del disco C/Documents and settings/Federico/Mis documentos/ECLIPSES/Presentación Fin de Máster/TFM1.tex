...
\onslide<2>
    \begin{itemize}
      \item Cono de penumbra
    \end{itemize}

\onslide<3>
    \begin{itemize}
      \item Eje de la sombra
    \end{itemize}
...
\only<4-6>{Divisi\'{o}n cl\'{a}sica de los eclipses

\begin{overprint}

\onslide<4>
    \begin{itemize}
      \item Eclipse parcial
    \end{itemize}
...
\only<7-11>{Divisi\'{o}n de los eclipses en este trabajo
...
\onslide<8>
    \begin{itemize}
      \item Eclipse no central
    \end{itemize}

\onslide<9>
    \begin{itemize}
      \item Eclipse central con una sola curva de totalidad
    \end{itemize}

\onslide<10>
    \begin{itemize}
      \item Eclipse central con una sola curva de parcialidad
    \end{itemize}

\onslide<11>
    \begin{itemize}
      \item Eclipse central con las dos curvas de parcialidad
    \end{itemize}
...
\only<9>{Eclipse Parcial}
\begin{overprint}
\onslide<1>
  \begin{itemize}
    \item Representaci\'{o}n completa
  \end{itemize}
  \begin{center}
...
\only<2->{Coordenadas del observador en el sistema fundamental}
...
\frametitle{Mapas}
\begin{overprint}
\only<1-2>{Comparaci\'{o}n Mapas Almanaque y Generado}
