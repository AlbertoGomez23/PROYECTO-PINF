...
\only<2>{Divisi\'{o}n cl\'{a}sica de los eclipses
    \begin{itemize}
      \item Eclipse parcial (arriba), total (centro) y anular (abajo)
    \end{itemize}
...
\only<3-7>{Divisi\'{o}n de los eclipses en este trabajo
...
Se calcula, mediante \verb"FindRoot", el instante en que los puntos de la curva de m\'{a}ximo en el horizonte tienen nula au distancia al borde del cono.}
