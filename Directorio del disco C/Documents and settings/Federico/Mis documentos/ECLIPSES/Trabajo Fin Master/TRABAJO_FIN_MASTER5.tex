...
En las figuras \ref{tipoE}, \ref{tipoD}, \ref{tipoC} y \ref{tipoA} se muestran ejemplos de los mapas generados por el programa, para distintos tipos de eclipses. Dos de ellos corresponden a los mapas de las figuras \ref{ejemploanular} y \ref{ejemploparcial} que se utilizaron para describir las distintas curvas.
