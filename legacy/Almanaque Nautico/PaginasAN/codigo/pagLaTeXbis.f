...
C        END IF
        ...
        IF(ida.LT.100)THEN
        	WRITE(path,'(A25,I4,A3,I4,I2,A4)')'/Almanaque Nautico/DATOS/',
     + 	     ano,'/AN',ano,ida,'.DAT'
        ELSE
        	WRITE(path,'(A25,I4,A3,I4,I3,A4)')'/Almanaque Nautico/DATOS/',
     + 	     ano,'/AN',ano,ida,'.DAT'
        END IF
...
C        OPEN(UNIT = 22, FILE = fichero, STATUS = 'UNKNOWN')
	  ...
	  OPEN(UNIT = 25, FILE = 'BORRAR.TXT')  !BORRRRAAAAAAARRRRR       
...
C	FORMAT ('\def\pmgsol{',A2,'\Hora\ ',A2,'\Mintp',A1,'}')   OJO: COPIA SEGURIDAD LINEA CÓDIGO


	  READ(21,'(A110)') fil1
        WRITE(22,204) fil1(7:8), fil1(10:10)

204   FORMAT ('\def\sdluna{',A2, '.',A1,'\Min','}')
C     FORMAT ('\def\sdluna{',A2,'\Minp',A1,'}') COPIA SEGURIDAD
 

        READ(21,'(A110)') fil1
        WRITE(22,205) fil1(8:9), fil1(11:11)

205   FORMAT ('\def\edad{',A2, '.',A1, '\Diap','}')
C     FORMAT ('\def\edad{',A2,'\Diap',A1,'}') COPIA SEGURIDAD

 
        READ(21,'(A110)') fil1
        IF (fil1(10:10).EQ.' ') fil1(10:10)='0'
	  WRITE(22,206) fil1(7:8), fil1(10:11) 
	  !!!!WRITE(25,206) fil1(7:8), fil1(10:11) !BORRRRRAAAAAARRR
...
207   FORMAT ('\def\pheu{',A2, '.',A1,'\Min','}')
C     FORMAT ('\def\pheu{',A2,'\Minp',A1,'}') COPIA SEGURIDAD


        READ(21,'(A110)') fil1
        WRITE(22,208) fil1(10:11), fil1(13:13)

208   FORMAT ('\def\phed{',A2, '.',A1,'\Min','}')
C     FORMAT ('\def\phed{',A2,'\Minp',A1,'}') COPIA SEGURIDAD

        READ(21,'(A110)') fil1
        WRITE(22,209) fil1(10:11), fil1(13:13)

209   FORMAT ('\def\phet{',A2, '.',A1,'\Min', '}')
C	FORMAT ('\def\phet{',A2,'\Minp',A1,'}')

        
        READ(21,'(A110)') fil1 
        WRITE(22,210) fil1(8:10)
	  !!!!!!WRITE(25,210) fil1(8:10) !BORRRRRAAAAAARRR
...
215   FORMAT ('\bf ',A2,'&',A3,'&',A4,'&$',A1,'$&',A2,'&',A4,'&',A3,'&',
	 ...
	 !!!!! WRITE(25,221) fil1(13:14), fil1(16:17), fil1(19:19) !BORRARRRRRRR

221   FORMAT ('\def\pmgaries{',A2,'\Hora\ ',A2, '.', A1,'\Mint','}')
c	FORMAT ('\def\pmgaries{',A2,'\Hora\ ',A2,'\Mintp',A1,'}')    COPIA DE LO ANTERIOR POR SEGURIDAD
...
27      CONTINUE
     ...
     +  v(i)(80:83), v(i)(85:85), v(i)(87:88), v(i)(90:93)
        ...
        !!!!WRITE(25,232) v(i)(2:3), v(i)(6:8), v(i)(10:13), v(i)(16:18), 
     + !!!! v(i)(20:23), v(i)(25:25), v(i)(27:28), v(i)(30:33), v(i)(36:38), 
     + !!!! v(i)(40:43), v(i)(45:45), v(i)(47:48), v(i)(50:53), v(i)(56:58), 
     + !!!! v(i)(60:63), v(i)(65:65), v(i)(67:68), v(i)(70:73), v(i)(76:78), 
     + !!!! v(i)(80:83), v(i)(85:85), v(i)(87:88), v(i)(90:93) !!!BORRAR ANTERIO
     ...
     +  v(i)(80:83), v(i)(85:85), v(i)(87:88), v(i)(90:93)
         ...
         WRITE(25,231) v(i)(2:3), v(i)(6:8), v(i)(10:13)  !BORRAR ANTERIOR
